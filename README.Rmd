...
The R package lrspline provides functions for fitting smoothing splines to massive data.

## Installation

You can install the *development* version of lrspline from [Github](https://github.com/danqingxu/lrspline):
